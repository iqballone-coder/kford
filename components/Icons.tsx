...
export const DisabilityIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M11 15h2a1 1 0 1 0 0-2h-2a1 1 0 1 0 0 2zm6-4a1 1 0 1 0-2 0 1 1 0 0 0 2 0zm-8 0a1 1 0 1 0-2 0 1 1 0 0 0 2 0z"/>
        <path d="M12 2a4 4 0 0 0-4 4c0 1.11.45 2.11 1.17 2.83A6.002 6.002 0 0 0 6 14v1a1 1 0 0 0 1 1h1v4a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1v-4h1a1 1 0 0 0 1-1v-1a6.002 6.002 0 0 0-3.17-5.17A3.999 3.999 0 0 0 16 6a4 4 0 0 0-4-4z"/>
    </svg>
);

export const WomenIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2C9.24 2 7 4.24 7 7c0 2.21 1.35 4.12 3.25 4.88L8 18h2v4h4v-4h2l-2.25-6.12C15.65 11.12 17 9.21 17 7c0-2.76-2.24-5-5-5z"/>
    </svg>
);
...
export const EducationIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M22 10v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V10l10-7 10 7z"/>
        <path d="M2 10l10 7 10-7"/>
        <path d="M12 22V12"/>
    </svg>
);

export const WashIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0L12 2.69z"/>
        <path d="M12 12a3 3 0 0 0-3 3c0 1.66 2 4 3 4s3-2.34 3-4a3 3 0 0 0-3-3z"/>
    </svg>
);
